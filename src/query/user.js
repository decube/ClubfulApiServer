module.exports = function() {
      return {
          ...
          updateOtherUser : 'update user_info set nickName=?, sex=?, birthDay=?,userLatitude=?,userLongitude=?, userAddress=?, userAddressShort=? where userID = ?',
