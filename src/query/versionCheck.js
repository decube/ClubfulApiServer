module.exports = function() {
      return {
          ...
          insertDevice : 'INSERT INTO device (token, deviceType, language, uuid, makeDT, updateDT, deviceVerSeq) values(?,?,?,?,now(),now(),(select seq from device_ver order by seq desc limit 1))',
