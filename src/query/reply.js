module.exports = function() {
      return {
          ...
          selectPagingReply : "select seq, content, makeDT as date, id as userId, nickName from reply reply , user_info info where reply.id = info.userId and courtSeq=? order by seq desc limit  (? - 1) * ?, ?",  
      };   
  }
