module.exports = function() {
      return {
          insertCourt : "INSERT INTO court (address, addressShort, cname, latitude, longitude, description, makeDT, updateDT, status, categorySeq, makenToken) VALUES ('aaaaa', 'bbbbb', 'cccccc', 'ddddd', 'eeeee', 'ffff', now(), now(), 'N', 2, 'Hi25MEkv7D/39biYfFpeFCNvXXLLBxjPDc8MaSIDtZM=')",
